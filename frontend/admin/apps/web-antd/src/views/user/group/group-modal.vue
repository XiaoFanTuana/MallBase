...
interface Props {
  visible: boolean;
  editData?: UserGroupApi.GroupItem | null;
}
...
const handleSubmit = async () => {
  try {
    ...
    if (isEdit.value) {
      await updateUserGroupApi(props.editData!.id, formData);
      message.success('更新成功');
    } else {
      await createUserGroupApi(formData);
