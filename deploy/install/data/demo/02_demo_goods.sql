...
(1, 5, 1, 'iPhone 15 Pro', '钛金属设计，A17 Pro 芯片', '/static/demo/iphone15pro.png', 2,
...
INSERT INTO `mb_goods` (`id`, `category_id`, `brand_id`, `name`, `subtitle`, `main_image`, `spec_type`, `spec_meta`, `description`, `price`, `market_price`, `stock`, `sales`, `unit`, `is_on_sale`, `is_recommend`, `is_new`, `is_hot`, `sort`) VALUES
(2, 5, 2, '华为 Mate 60 Pro', '遥遥领先，卫星通信', '/static/demo/mate60pro.png', 2,
...
-- ---- 商品 3：小米14（多规格）----
INSERT INTO `mb_goods` (`id`, `category_id`, `brand_id`, `name`, `subtitle`, `main_image`, `spec_type`, `spec_meta`, `description`, `price`, `market_price`, `stock`, `sales`, `unit`, `is_on_sale`, `is_recommend`, `is_new`, `is_hot`, `sort`) VALUES
(3, 5, 3, '小米14', '徕卡光学，骁龙8 Gen3', '/static/demo/xiaomi14.png', 2,
...
(4, 7, NULL, '经典纯棉圆领T恤', '100%新疆长绒棉', '/static/demo/tshirt.png', 2,
...
-- ---- 商品 5：坚果礼盒（单规格）----
INSERT INTO `mb_goods` (`id`, `category_id`, `brand_id`, `name`, `subtitle`, `main_image`, `spec_type`, `description`, `price`, `market_price`, `stock`, `sales`, `unit`, `is_on_sale`, `is_recommend`, `sort`) VALUES
(5, 9, NULL, '每日坚果混合礼盒', '750g/30包 每日一包', '/static/demo/nuts.png', 1,
