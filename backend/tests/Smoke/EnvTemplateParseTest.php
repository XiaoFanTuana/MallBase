...
final class EnvTemplateParseTest extends TestCase
{
    ...
    public function testEnsureEnvDerivesBackendEnvAndSyncsSwooleWorkerNum(): void
    {
        ...
        try {
            ...
            $this->assertFileEquals($backendEnvPath, $root . '/runtime-config/backend.env');
    ...
    public function testEnsureEnvMigratesLegacyRedisPortToHostMapping(): void
    {
        ...
        try {
            ...
            $clearedBackend = @parse_ini_file($backendEnvPath, true, INI_SCANNER_RAW);
    ...
    {
        foreach (['.env', 'backend/.env', 'backend/.mallbase-env'] as $relativePath) {
