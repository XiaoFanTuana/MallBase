...
Route::group('auth/permission', function () {
    ...
    // 详情
    Route::get('info', 'info')->option(['_alias' => '详情', '_desc' => '权限详情', '_auth' => true]);
    // 创建
    Route::post('create', 'create')->option(['_alias' => '创建', '_desc' => '创建权限', '_auth' => true]);
    // 更新
    Route::post('update', 'update')->option(['_alias' => '更新', '_desc' => '更新权限', '_auth' => true]);
    // 删除
    Route::post('delete', 'delete')->option(['_alias' => '删除', '_desc' => '删除权限', '_auth' => true]);
