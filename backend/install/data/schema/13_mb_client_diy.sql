...
(2, 'profile', '系统默认个人中心', '系统内置个人中心方案，不能修改或删除',
 JSON_OBJECT('pageStyle', JSON_OBJECT('paddingTop', 10, 'paddingX', 28), 'modules', JSON_ARRAY(
   JSON_OBJECT('id', 'profile-user', 'type', 'userInfo', 'props', JSON_OBJECT('background', '', 'backgroundColorEnd', '#ffffff', 'backgroundColorStart', '#ffffff', 'backgroundGradientDirection', 'horizontal', 'backgroundMode', 'color', 'background_image', '', 'borderColor', '#e5e5e5', 'borderEnabled', true, 'borderStyle', 'dashed', 'borderWidth', 1, 'marginBottom', 0, 'marginLeft', 0, 'marginRight', 0, 'marginTop', 0, 'padding', 0, 'paddingX', 28, 'paddingY', 28, 'radius', 0, 'shadowEnabled', false, 'widthPercent', 100, 'show_mobile', true)),
   JSON_OBJECT('id', 'profile-order', 'type', 'orderEntry', 'props', JSON_OBJECT('background', '', 'backgroundColorEnd', '#ffffff', 'backgroundColorStart', '#ffffff', 'backgroundGradientDirection', 'horizontal', 'backgroundMode', 'color', 'background_image', '', 'borderColor', '#e5e5e5', 'borderEnabled', true, 'borderStyle', 'dashed', 'borderWidth', 1, 'marginBottom', 0, 'marginLeft', 0, 'marginRight', 0, 'marginTop', 0, 'padding', 0, 'paddingX', 28, 'paddingY', 28, 'radius', 20, 'shadowEnabled', false, 'widthPercent', 100, 'title', '我的订单', 'display', 'grid', 'items', JSON_ARRAY(JSON_OBJECT('title', '待付款', 'label', '待付款', 'image', 'static/demo/profile-order-pay.svg', 'path', '/pages-sub/order/list?status=10'), JSON_OBJECT('title', '待发货', 'label', '待发货', 'image', 'static/demo/profile-order-ship.svg', 'path', '/pages-sub/order/list?status=20'), JSON_OBJECT('title', '待收货', 'label', '待收货', 'image', 'static/demo/profile-order-receive.svg', 'path', '/pages-sub/order/list?status=30'), JSON_OBJECT('title', '退款售后', 'label', '退款售后', 'image', 'static/demo/profile-order-refund.svg', 'path', '/pages-sub/refund/list')))),
   JSON_OBJECT('id', 'profile-wallet', 'type', 'walletEntry', 'props', JSON_OBJECT('background', '', 'backgroundColorEnd', '#ffffff', 'backgroundColorStart', '#ffffff', 'backgroundGradientDirection', 'horizontal', 'backgroundMode', 'color', 'background_image', '', 'borderColor', '#e5e5e5', 'borderEnabled', true, 'borderStyle', 'dashed', 'borderWidth', 1, 'marginBottom', 0, 'marginLeft', 0, 'marginRight', 0, 'marginTop', 0, 'padding', 0, 'paddingX', 28, 'paddingY', 28, 'radius', 20, 'shadowEnabled', false, 'widthPercent', 100, 'title', '我的余额', 'show_balance', true, 'show_records', true, 'show_view_button', true)),
   JSON_OBJECT('id', 'profile-service', 'type', 'serviceMenu', 'props', JSON_OBJECT('background', '', 'backgroundColorEnd', '#ffffff', 'backgroundColorStart', '#ffffff', 'backgroundGradientDirection', 'horizontal', 'backgroundMode', 'color', 'background_image', '', 'borderColor', '#e5e5e5', 'borderEnabled', true, 'borderStyle', 'dashed', 'borderWidth', 1, 'marginBottom', 0, 'marginLeft', 0, 'marginRight', 0, 'marginTop', 0, 'padding', 0, 'paddingX', 10, 'paddingY', 0, 'radius', 20, 'shadowEnabled', false, 'widthPercent', 100, 'title', '我的服务', 'display', 'list', 'columns', 4, 'items', JSON_ARRAY(JSON_OBJECT('title', '地址管理', 'label', '地址管理', 'image', 'static/demo/profile-service-address.svg', 'path', '/pages-sub/address/list'), JSON_OBJECT('title', '我的收藏', 'label', '我的收藏', 'image', 'static/demo/profile-service-favorite.svg', 'path', ''), JSON_OBJECT('title', '主题设置', 'label', '主题设置', 'image', 'static/demo/profile-service-settings.svg', 'path', '/pages-sub/user/settings'), JSON_OBJECT('title', '联系客服', 'label', '联系客服', 'image', 'static/demo/profile-service-support.svg', 'path', ''))))
  )), 'native', 1, 1, 20, 1),
